...
#
#  GTOMm: Generalized Topological Overlap Measure with m=2
# 
...
# wf SIGNATURE
wf.NAME = "GTOM2"
wf.DESC = "For each undirected edge {u,v}, assigns weight(u,v) = GTOM2(u, v)"
wf.ARGS = list()
wf.MIXEDGES = TRUE
wf.VERBOSE = FALSE

GTOM2 <- function(graph)
{   
    m = 2
    #cat(paste("* Computing GTOM2", "...", sep = ""))
    ...
    # cat(sprintf("* TIMING: GTOM2 re-assigning took %s minutes \n", dt))
